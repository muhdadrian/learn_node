//1st, go to detail.ejs
//2nd, go to the bottom of the delete route below
...
//3rd, we make the form (copy and paste from add contact data form page above)
//edit contact data form
app.get('/contact/edit/:name', (req, res) => {
  const contact = findContact(req.params.name); //4th find based on req.params.name and we'll get the contact to be passed at 5th below

  res.render('edit-contact', {
    title: 'Edit Data Contact Form',
    layout: 'layouts/main-layout',
    contact, //5th (this same with contact: contact)
    //6th, we make view. Go to views folder and make a new file: edit-contact.ejs
  });
});
