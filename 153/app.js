...
//3rd, we make the route based on the action="/contact/update" (the form in edit-contact.ejs)
//edit data process
app.post('/contact/update', (req, res) => {
  res.send(req.body); //4th we try to capture the data sent from the form
  //5th, try to edit a data (Adrian James Nandu). The result will be displayed in json format, which include old and new name etc.
  //6th, we'll make validation in 154
});
